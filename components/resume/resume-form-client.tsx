          ...
          {CATEGORIES.map(({ key, name, description, icon: Icon, accent }) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "group relative min-h-28 overflow-hidden rounded-xl border bg-white p-4 text-left shadow-sm outline-none",
              ...
              >
                ...
                {selected && (
                  <div className="absolute right-3 top-3 flex size-7 items-center justify-center rounded-full bg-tech-green text-white shadow-[0_8px_18px_rgba(122,201,67,0.28)]">
                ...
                <div className="flex items-center gap-4">
                  <div
                    className={cn(
                      "flex size-11 shrink-0 items-center justify-center rounded-full transition-transform duration-300 group-hover:scale-105",
                      accent
                    )}
                  >
        ...
        >
          ...
          <div key={selectedKey} className="animate-in fade-in slide-in-from-bottom-2 duration-500">
            <div className="overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-[0_18px_50px_rgba(15,23,42,0.08)]">
              <div className="relative overflow-hidden bg-[#071426] px-6 py-7 text-white sm:px-8">
                ...
                <div className="relative flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex h-11 shrink-0 items-center justify-center gap-2 rounded-full bg-tech-green px-5 text-sm font-bold text-[#071426] shadow-[0_10px_26px_rgba(122,201,67,0.26)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-tech-green/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-tech-green/40"
                  >
