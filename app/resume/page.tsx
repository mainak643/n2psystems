...
export default function SubmitResumePage() {
  return (
    <main className="bg-frost">
      <section className="relative overflow-hidden bg-[#071426] pb-10 pt-24 sm:pb-16 md:pb-20 md:pt-28">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
            <div className="mb-4 sm:mb-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.06] px-3 sm:px-4 py-1.5 sm:py-2 text-xs font-semibold text-white shadow-2xl shadow-black/10 backdrop-blur">
            ...
            <h1 className="text-[1.65rem] font-bold tracking-tight text-white sm:text-5xl lg:text-6xl text-balance leading-[1.15]">
      ...
      <section className="relative bg-frost py-8 sm:py-12 md:py-16">
